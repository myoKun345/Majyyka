...
object WandCoreRedstone extends WandCore(5.0F, new ItemStack(Core, 1, 4))
object WandCoreLapis extends WandCore(3.0F, new ItemStack(Core, 1, 5))
object WandCoreObsidian extends WandCore(6.0F, new ItemStack(Core, 1, 6))
...
object WandHandleRedstone extends WandHandle(5.0F, new ItemStack(Handle, 1, 9))
object WandHandleLapis extends WandHandle(3.0F, new ItemStack(Handle, 1, 10))
object WandHandleObsidian extends WandHandle(4.0F, new ItemStack(Handle, 1, 11))
